...
class BaseNavCon: UINavigationController {
    ...
    override func pushViewController(_ viewController: UIViewController, animated: Bool) {
        ...
        guard let viewController = viewController as? BaseVC else { return }
    ...
    func setupViewControllerBasedNavigationBarAppearanceIfNeeded(_ appearingViewController: BaseVC) {
        ...
        if let disappearingViewController = viewControllers.last as? BaseVC {
